...
-- 1- Bring the employees who work in the film department OR in the clothing department"

-- First we need to get the quantity of each one to optimize the search
SELECT COUNT(*), departamento
FROM employees
GROUP BY departamento
ORDER BY 1;

-- We found filmes = 21 and roupas = 53.
/* As we are working with 'or,' and the second condition is optional, 
we place in the first condition whoever has a higher chance of a 
true outcome, as the second condition will not be checked in this case. */
...
/* 2- The marketing manager requested the list of female employees who 
work in the Film department or in the Home department. He needs to send an 
email to the female collaborators of these two sectors. OR + AND * */


SELECT count(*), sexo
FROM employees
GROUP BY sexo;
-- We found 491 female employees. We also have  52 - Lar and  21 - Filmes
...
-- Bring the male employees or the employees who work in the Garden sector
